(function() {
  ...
  banner.innerHTML =
    ...
    '<button id="cookie-accept" style="background:#fff;color:#506352;border:none;border-radius:9999px;padding:8px 20px;font-family:Montserrat,sans-serif;font-size:12px;font-weight:600;cursor:pointer">Aceptar</button>' +
    '<button id="cookie-reject" style="background:transparent;color:#fff;border:1px solid #fff;border-radius:9999px;padding:8px 20px;font-family:Montserrat,sans-serif;font-size:12px;font-weight:600;cursor:pointer">Rechazar</button>' +
    '</div>';
